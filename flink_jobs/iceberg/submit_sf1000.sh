...
EOF
    ...
    for TABLE in "${TABLES[@]}"; do
        case $TABLE in
            ...
            transfer)        FIELDS="id BIGINT, sourceid INT, targetid INT, amount FLOAT, type STRING, ts TIMESTAMP(6), freshness_ts TIMESTAMP(6)" ;;
...
EOF
    ...
    for TABLE in "${TABLES[@]}"; do
        ...
        cat <<EOF >> "$CUR_SQL"
  INSERT INTO \`iceberg\`.\`hybench_sf1000\`.\`$TABLE\` 
