...
# --- 配置 ---
SOURCE_S3="s3://home-dongyang/paimon/hybench_sf1000.db/"
# 建议备份路径带上时间戳或固定版本号
BACKUP_S3="s3://home-dongyang/paimon/hybench_sf1000.db.dv.none.fullCompaction.bak/"
...
# 2. 定义表清单 (按数据量从大到小排序)
TABLES=("transfer" "checking" "loanapps" "loantrans" "savingaccount" "checkingaccount" "customer" "company")
