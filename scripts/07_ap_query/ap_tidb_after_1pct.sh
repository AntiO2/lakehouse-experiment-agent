#!/bin/bash
# ============================================================
# Run AP queries after 1% update on TiDB
# Usage: ./scripts/07_ap_query/ap_tidb_after_1pct.sh [run_id]
# ============================================================
set -euo pipefail
...
LOG_FILE="${LOG_DIR}/ap_tidb_1pct_run${RUN}_$(date +%Y%m%d_%H%M%S).log"

echo ">>> running AP benchmark (TiDB/TiFlash, after 1% update, run ${RUN})"
echo ">>> log: ${LOG_FILE}"
